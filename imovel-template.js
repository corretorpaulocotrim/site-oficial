...
const FALLBACK_ICON = `<svg viewBox="0 0 24 24" style="width:14px;height:14px;stroke:#0058A3;fill:none;stroke-width:3;vertical-align:-2px" class="amen-ic"><path d="M4 12l5 5L20 6"/></svg>`;
const FALLBACK_ICON_INLINE = `<svg viewBox="0 0 24 24" style="width:14px;height:14px;stroke:#0058A3;fill:none;stroke-width:3;vertical-align:-2px" class="amen-ic"><path d="M4 12l5 5L20 6"/></svg>`;
...
const amenIcons={
  'Piscinas':`<svg viewBox="0 0 24 24" style="width:18px;height:18px;stroke:var(--gold,#0058A3);fill:none;stroke-width:2" class="amen-ic"><rect x="3" y="5" width="18" height="9" rx="2"/><path d="M2 19c2 0 2-2 4-2s2 2 4 2 2-2 4-2 2 2 4 2 2-2 4-2"/></svg>`,
  'Piscina':`<svg viewBox="0 0 24 24" style="width:18px;height:18px;stroke:var(--gold,#0058A3);fill:none;stroke-width:2" class="amen-ic"><rect x="3" y="5" width="18" height="9" rx="2"/><path d="M2 19c2 0 2-2 4-2s2 2 4 2 2-2 4-2 2 2 4 2 2-2 4-2"/></svg>`,
  'Rooftop':`<svg viewBox="0 0 24 24" style="width:18px;height:18px;stroke:var(--gold,#0058A3);fill:none;stroke-width:2" class="amen-ic"><path d="M4 21V10l8-6 8 6v11"/><path d="M9 21v-6h6v6"/></svg>`,
  'Solário':`<svg viewBox="0 0 24 24" style="width:18px;height:18px;stroke:var(--gold,#0058A3);fill:none;stroke-width:2" class="amen-ic"><circle cx="12" cy="12" r="4"/><path d="M12 2v3M12 19v3M4.2 4.2l2.1 2.1M17.7 17.7l2.1 2.1M2 12h3M19 12h3M4.2 19.8l2.1-2.1M17.7 6.3l2.1-2.1"/></svg>`,
  'Academia':`<svg viewBox="0 0 24 24" style="width:18px;height:18px;stroke:var(--gold,#0058A3);fill:none;stroke-width:2" class="amen-ic"><path d="M6 7v10M18 7v10M6 12h12"/><rect x="3" y="9" width="3" height="6" rx="1"/><rect x="18" y="9" width="3" height="6" rx="1"/></svg>`,
  'Churrasqueira':`<svg viewBox="0 0 24 24" style="width:18px;height:18px;stroke:var(--gold,#0058A3);fill:none;stroke-width:2" class="amen-ic"><path d="M12 2s-5 5-5 10a5 5 0 0010 0c0-2-1-3-1-3s-1 2-2 2c-1 0-1-2 0-4 0 0-2 1-2-5z"/></svg>`,
  'Apoio Churrasqueira':`<svg viewBox="0 0 24 24" style="width:18px;height:18px;stroke:var(--gold,#0058A3);fill:none;stroke-width:2" class="amen-ic"><path d="M12 2s-5 5-5 10a5 5 0 0010 0c0-2-1-3-1-3s-1 2-2 2c-1 0-1-2 0-4 0 0-2 1-2-5z"/></svg>`,
  'Salão de Festas':`<svg viewBox="0 0 24 24" style="width:18px;height:18px;stroke:var(--gold,#0058A3);fill:none;stroke-width:2" class="amen-ic"><path d="M6 8a6 6 0 0112 0c0 7 3 8 3 8H3s3-1 3-8z"/><path d="M10 20a2 2 0 004 0"/></svg>`,
  'Apoio Festas':`<svg viewBox="0 0 24 24" style="width:18px;height:18px;stroke:var(--gold,#0058A3);fill:none;stroke-width:2" class="amen-ic"><path d="M6 8a6 6 0 0112 0c0 7 3 8 3 8H3s3-1 3-8z"/><path d="M10 20a2 2 0 004 0"/></svg>`,
  'Playground':`<svg viewBox="0 0 24 24" style="width:18px;height:18px;stroke:var(--gold,#0058A3);fill:none;stroke-width:2" class="amen-ic"><path d="M4 4v16M20 4v16M4 4h16"/><path d="M8 10l4 4 4-4"/></svg>`,
  'Horta':`<svg viewBox="0 0 24 24" style="width:18px;height:18px;stroke:var(--gold,#0058A3);fill:none;stroke-width:2" class="amen-ic"><path d="M12 21c-5-2-8-6-8-11a8 8 0 0116 0c0 5-3 9-8 11z"/><path d="M12 21V8"/></svg>`,
  'Beach Tênis':`<svg viewBox="0 0 24 24" style="width:18px;height:18px;stroke:var(--gold,#0058A3);fill:none;stroke-width:2" class="amen-ic"><circle cx="12" cy="12" r="8"/><path d="M4 8c4 2 4 6 0 8M20 8c-4 2-4 6 0 8"/></svg>`,
  'Futmesa':`<svg viewBox="0 0 24 24" style="width:18px;height:18px;stroke:var(--gold,#0058A3);fill:none;stroke-width:2" class="amen-ic"><circle cx="12" cy="12" r="9"/><path d="M12 8l3 2-1 4h-4l-1-4z"/></svg>`,
  'Espaço Gourmet':`<svg viewBox="0 0 24 24" style="width:18px;height:18px;stroke:var(--gold,#0058A3);fill:none;stroke-width:2" class="amen-ic"><path d="M7 3v7a2 2 0 002 2v9M7 3v4M9 3v4M11 3v9M17 3c-2 0-3 2-3 5s1 5 3 5v8"/></svg>`,
  'Espaço Zen':`<svg viewBox="0 0 24 24" style="width:18px;height:18px;stroke:var(--gold,#0058A3);fill:none;stroke-width:2" class="amen-ic"><circle cx="12" cy="9" r="3"/><path d="M12 12v9M8 21c0-3 2-4 4-4s4 1 4 4"/></svg>`,
  'Pet Place':`<svg viewBox="0 0 24 24" style="width:18px;height:18px;stroke:var(--gold,#0058A3);fill:none;stroke-width:2" class="amen-ic"><circle cx="8" cy="9" r="1.5"/><circle cx="12" cy="7" r="1.5"/><circle cx="16" cy="9" r="1.5"/><path d="M12 12c-3 0-5 2-5 4.5A2.5 2.5 0 009.5 19c1 0 1.3-.5 2.5-.5s1.5.5 2.5.5a2.5 2.5 0 002.5-2.5c0-2.5-2-4.5-5-4.5z"/></svg>`,
  'Pet Care':`<svg viewBox="0 0 24 24" style="width:18px;height:18px;stroke:var(--gold,#0058A3);fill:none;stroke-width:2" class="amen-ic"><circle cx="8" cy="9" r="1.5"/><circle cx="12" cy="7" r="1.5"/><circle cx="16" cy="9" r="1.5"/><path d="M12 12c-3 0-5 2-5 4.5A2.5 2.5 0 009.5 19c1 0 1.3-.5 2.5-.5s1.5.5 2.5.5a2.5 2.5 0 002.5-2.5c0-2.5-2-4.5-5-4.5z"/></svg>`,
  'Petplace':`<svg viewBox="0 0 24 24" style="width:18px;height:18px;stroke:var(--gold,#0058A3);fill:none;stroke-width:2" class="amen-ic"><circle cx="8" cy="9" r="1.5"/><circle cx="12" cy="7" r="1.5"/><circle cx="16" cy="9" r="1.5"/><path d="M12 12c-3 0-5 2-5 4.5A2.5 2.5 0 009.5 19c1 0 1.3-.5 2.5-.5s1.5.5 2.5.5a2.5 2.5 0 002.5-2.5c0-2.5-2-4.5-5-4.5z"/></svg>`,
  'Espaço Relax':`<svg viewBox="0 0 24 24" style="width:18px;height:18px;stroke:var(--gold,#0058A3);fill:none;stroke-width:2" class="amen-ic"><path d="M4 12v6M20 12v6M4 18h16M5 12V9a2 2 0 012-2h10a2 2 0 012 2v3M7 12h10"/></svg>`,
  'Praça':`<svg viewBox="0 0 24 24" style="width:18px;height:18px;stroke:var(--gold,#0058A3);fill:none;stroke-width:2" class="amen-ic"><circle cx="12" cy="8" r="5"/><path d="M12 13v8"/></svg>`,
  'Bike LEV':`<svg viewBox="0 0 24 24" style="width:18px;height:18px;stroke:var(--gold,#0058A3);fill:none;stroke-width:2" class="amen-ic"><circle cx="6" cy="17" r="3"/><circle cx="18" cy="17" r="3"/><path d="M6 17l4-9h5l3 9M10 8h4"/></svg>`,
  'Quadra Poliesportiva':`<svg viewBox="0 0 24 24" style="width:18px;height:18px;stroke:var(--gold,#0058A3);fill:none;stroke-width:2" class="amen-ic"><rect x="3" y="5" width="18" height="14" rx="2"/><path d="M12 5v14M3 12h18"/><path d="M7 5a5 5 0 010 14M17 5a5 5 0 000 14"/></svg>`,
  'Sauna':`<svg viewBox="0 0 24 24" style="width:18px;height:18px;stroke:var(--gold,#0058A3);fill:none;stroke-width:2" class="amen-ic"><path d="M6 21v-3a3 3 0 013-3h6a3 3 0 013 3v3"/><path d="M8 11c-1-1-1-3 0-4M12 9c-1-1-1-3 0-4M16 11c-1-1-1-3 0-4"/></svg>`,
  'Lavanderia':`<svg viewBox="0 0 24 24" style="width:18px;height:18px;stroke:var(--gold,#0058A3);fill:none;stroke-width:2" class="amen-ic"><circle cx="12" cy="13" r="7"/><circle cx="8" cy="6" r="2"/><circle cx="16" cy="6" r="2"/></svg>`
};
  ...
  <header class="im-hdr">
    <a href="index.html" class="im-hdr-logo" style="display:flex;align-items:center;gap:10px;text-decoration:none">
      ...
      <div style="display:flex;flex-direction:column;gap:1px;line-height:1">
        ...
        <span style="color:#2a7fc0;font-size:9px;font-weight:700;letter-spacing:.1em;text-transform:uppercase">Especialista em lançamentos · CRECI-RJ 77677-F</span>
      </div>
    </a>
      ...
      <div class="section-block">
        ...
        ${PROP.planta
          ...
          : `<div class="planta-cta-box">
              <div class="planta-icon"><svg viewBox="0 0 24 24" style="width:26px;height:26px;stroke:#0058A3;fill:none;stroke-width:1.8"><rect x="3" y="3" width="18" height="18" rx="1"/><path d="M3 9h18M9 3v18M9 13h6v6"/></svg></div>
      ...
      <div class="section-block">
        ...
        <div class="im-loc-points">
          ${PROP.standLat?`<div class="im-loc-pt">
            <div class="im-loc-pt-label"><svg viewBox="0 0 24 24" style="width:14px;height:14px;stroke:#0058A3;fill:none;stroke-width:2;vertical-align:-2px;margin-right:4px" class="ic-inline"><path d="M3 21h18M6 21V10l6-4 6 4v11M10 21v-6h4v6"/></svg>Stand de Vendas</div>
        ...
        <div class="im-map-route-wrap">
          ...
          <div class="im-route-card">
            <div class="im-route-title"><svg viewBox="0 0 24 24" style="width:15px;height:15px;stroke:#0058A3;fill:none;stroke-width:2;vertical-align:-3px;margin-right:5px" class="ic-inline"><path d="M9 20l-5.5-2V4L9 6M9 20l6-2M9 20V6M15 18l6 2V6l-6-2M15 18V4"/></svg>Calcule sua rota até aqui</div>
    ...
    <div class="im-sidebar">
      <div class="sid-card sid-sticky">
        ...
        <div class="sid-info">
          ...
          <div class="sid-row"><span class="sid-label">Status</span><span class="sid-value" style="color:#0058A3">${PROP.tipo}</span></div>
        </div>
        ...
        <div style="border-top:1px solid #f1f5f9;padding-top:10px;margin-top:2px">
          ...
          <button class="btn-proposta-sid-completa" onclick="solicitarPropostaCompleta()" style="display:flex;align-items:center;gap:6px;width:100%;padding:9px 12px;background:linear-gradient(135deg,#0058A3,#004a8a);border:none;border-radius:8px;font-size:12px;font-weight:700;color:#fff;cursor:pointer;font-family:inherit">Com apresentação PDF</button>
        </div>
      </div>
...
window.baixarPropostaSimples = function(){
  ...
  const amens = (p.amenidades||[]).map(a=>`<li style="margin-bottom:4px"><svg viewBox="0 0 24 24" style="width:14px;height:14px;stroke:#0058A3;fill:none;stroke-width:3;vertical-align:-2px" class="amen-ic"><path d="M4 12l5 5L20 6"/></svg> ${a}</li>`).join('');
