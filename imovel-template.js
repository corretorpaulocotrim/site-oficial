...
const FALLBACK_ICON = `<svg viewBox="0 0 24 24" style="width:14px;height:14px;stroke:#3E8E5A;fill:none;stroke-width:3;vertical-align:-2px" class="amen-ic"><path d="M4 12l5 5L20 6"/></svg>`;
const FALLBACK_ICON_INLINE = `<svg viewBox="0 0 24 24" style="width:14px;height:14px;stroke:#3E8E5A;fill:none;stroke-width:3;vertical-align:-2px" class="amen-ic"><path d="M4 12l5 5L20 6"/></svg>`;
...
window.baixarPropostaSimples = function(){
  ...
  const amens = (p.amenidades||[]).map(a=>`<li style="margin-bottom:4px"><svg viewBox="0 0 24 24" style="width:14px;height:14px;stroke:#3E8E5A;fill:none;stroke-width:3;vertical-align:-2px" class="amen-ic"><path d="M4 12l5 5L20 6"/></svg> ${a}</li>`).join('');
