...
/* AUDIT fix: agende / renda-de-app / obras-decorados / acompanhe */
.v-card,.howto,.authority,.f-search,.antes,.agora,.plat-rule,.obra-card,.obras-info,.vid-card,.vid-featured,.vid-section,.help,.mp-go{background:#0b1a1d !important;border-color:rgba(207,159,79,.16) !important;color:#f4efe6 !important}
.v-card *,.howto *,.antes *,.agora *,.obra-card *,.vid-card *,.vid-featured *,.help *,.obras-info *{color:#f4efe6 !important}
.agora{background:#0f2a1c !important;border-color:rgba(26,143,76,.35) !important}
.plat-rule{color:#e6c581 !important}
